...
Once we have implemented something we record screenshots of the released version and add them to the scoping section of the team Google Drive as a record of the final implementation.
